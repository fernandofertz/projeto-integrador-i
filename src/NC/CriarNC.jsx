...
const CriarNC = () => {
    ...
    const onFinish = () => {
      ...
      axios.post('http://localhost:8080/api/v1/nc/create', json, config)
        .then((response) => {
    ...
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', width:'95%', marginTop:'50px'}}>
        <Form.Item label="Setor que fez o registro" name="setor" style={{ width:'30%'}}>
          <Select value = {selectedValues.setor} onChange={(value) => handleSelectChange("setor", value)}>
        ...
        <Form.Item label="Setor de origem" name="tipo_nc" style={{width: '30%'}}>
          <Select value = {selectedValues.tipo_nc} onChange={(value) => handleSelectChange("tipo_nc", value)}>
            <Option value="Triagem">Triagem</Option>
        ...
        <Form.Item label="Num Sequencial" name="num_sequencial" style={{width:'30%'}}>
          <Input onChange={(event) => handleChange("num_sequencial", event.target.value)} />
        </Form.Item>
        <Form.Item label="Num Guia" name="num_guia" style={{width:'30%'}}>
          <Input onChange={(event) => handleChange("num_guia", event.target.value)}/>
        </Form.Item>
        <Form.Item label="Nome Funcionário" name="id_colaborador" style={{width:'30%'}}>
          <Input onChange={(event) => handleChange("id_colaborador", event.target.value)}/>
        </Form.Item>
        </div>
        <div style={{ display: 'flex' ,justifyContent: 'space-between', width:'95%'}}>
        <Form.Item label="Tipo de Notificação" name="id_tipo" style={{width:'38%'}}>
          <Select value = {selectedValues.id_tipo} onChange={(value) => handleSelectChange("id_tipo", value)}>
      ...
      <Form.Item label="Classificação" name="classificacao" style={{width:'26%'}}>
        <Select value = {selectedValues.classificacao} onChange={(value) => handleSelectChange("classificacao", value)}>
      ...
      <Form.Item label="Responsabilidade" name="responsabilidade" style={{width:'26%'}}>
        <Select value = {selectedValues.responsabilidade} onChange={(value) => handleSelectChange("responsabilidade", value)}>
      ...
      <Form.Item label="Classificação do incidente" name="incidente" style={{width:'30%'}}>
        <Select value = {selectedValues.incidente} onChange={(value) => handleSelectChange("incidente", value)}>
      ...
      <Form.Item label="Classificação do Evento" name="evento" style={{width:'30%'}}>
        <Select value = {selectedValues.evento} onChange={(value) => handleSelectChange("evento", value)}>
      ...
      <Form.Item label="Fase em que ocorreu" name="fase" style={{width:'30%'}}>
        <Select value = {selectedValues.fase} onChange={(value) => handleSelectChange("fase", value)}>
      ...
      <Form.Item label="A falha é recorrente?" name="recorrencia" style={{ width: '45%' }}>
        <Select
          value={selectedValues.recorrencia}
      ...
      <Form.Item label="Classificação do evento adverso" name="dano" style={{width:'45%'}}>
        <Select value = {selectedValues.dano} onChange={(value) => handleSelectChange("dano", value)}>
      ...
      <Form.Item label="Causa Raiz" name="causa_raiz" style={{width:'45%'}}>
        <Input.TextArea onChange={(event) => handleChange("causa_raiz", event.target.value)}/>
      </Form.Item>
      <Form.Item label="Descrição" name="descricao" style={{width:'45%'}}>
        <Input.TextArea onChange={(event) => handleChange("descricao", event.target.value)}/>
      </Form.Item>
      </div>
      <div style={{ display: 'flex', justifyContent: 'space-between', width:'95%' }}>
      <Form.Item label="Ação de correção" name="correcao"  style={{width:'45%'}}>
        <Input.TextArea onChange={(event) => handleChange("correcao", event.target.value)}/>
      </Form.Item>
      <Form.Item label="Ações de melhoria" name="melhoria"  style={{width:'45%'}}> 
        <Input.TextArea onChange={(event) => handleChange("melhoria", event.target.value)}/>
      </Form.Item>
      </div>
      <div style={{ display: 'flex', justifyContent: 'space-between', width:'95%'}}>
      <Form.Item label="Data de Fechamento" name="dt_fechamento" style={{width:'45%'}}>
          <Input type="date" onChange={(event) => handleChange("dt_fechamento", event.target.value)}/>
        </Form.Item>
        <Form.Item label="Conclusão da notificação" name="status" style={{width:'45%'}}>
        <Select value = {selectedValues.status} onChange={(value) => handleSelectChange("status", value)}>
